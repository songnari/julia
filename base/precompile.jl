...
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{IO}}})
precompile(Tuple{Type{Base.Option{IO}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{AbstractString}}})
precompile(Tuple{Type{Base.Option{AbstractString}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{Integer}}})
precompile(Tuple{Type{Base.Option{Integer}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{Union{Int64, Symbol}}}})
precompile(Tuple{Type{Base.Option{Union{Int64, Symbol}}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{Base.Cmd}}})
precompile(Tuple{Type{Base.Option{Base.Cmd}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{Any}}})
precompile(Tuple{Type{Base.Option{Any}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{Bool}}})
precompile(Tuple{Type{Base.Option{Bool}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{Base.Process}}})
precompile(Tuple{Type{Base.Option{Base.Process}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{Base.Dict{K, V} where V where K}}})
precompile(Tuple{Type{Base.Option{Base.Dict{K, V} where V where K}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Option{Array{T, N} where N where T}}})
precompile(Tuple{Type{Base.Option{Array{T, N} where N where T}}})
precompile(Tuple{typeof(Base.convert), Type{Base.Option{Base.Process}}, Base.Process})
precompile(Tuple{typeof(Base.convert), Type{Base.Option{Bool}}, Bool})
...
precompile(Tuple{typeof(Base.unpreserve_handle), Base.Timer})
precompile(Tuple{typeof(Base.disassociate_julia_struct), Base.Timer})
precompile(Tuple{typeof(Base.convert), Type{Base.Option{AbstractString}}, Base.SubString{String}})
...
precompile(Tuple{typeof(Base.print), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.TCPSocket})
precompile(Tuple{typeof(Base.isopen), Base.TCPSocket})
precompile(Tuple{typeof(Base.convert), Type{Base.Option{AbstractString}}, String})
precompile(Tuple{typeof(Base.unpreserve_handle), Base.TCPSocket})
precompile(Tuple{typeof(Base.check_open), Base.TCPSocket})
precompile(Tuple{typeof(Base.stream_wait), Base.TCPSocket, Base.Condition})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Option{Base.VersionNumber}}, Base.Option{Base.VersionNumber}})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Distributed.WorkerConfig}, Base.Distributed.WorkerConfig})
precompile(Tuple{typeof(Base.convert), Type{Base.Option{Base.VersionNumber}}, Base.VersionNumber})
precompile(Tuple{typeof(Base.Distributed.send_connection_hdr), Base.Distributed.Worker, Bool})
precompile(Tuple{typeof(Base.unsafe_write), Base.TCPSocket, Ptr{UInt8}, UInt64})
...
precompile(Tuple{typeof(Base.get), Base.Option{Base.Dict{K, V} where V where K}, Base.Dict{Any, Any}})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Option{Base.Dict{K, V} where V where K}}, Base.Dict{Any, Any}})
precompile(Tuple{typeof(Base.convert), Type{Base.Option{Integer}}, Int64})
precompile(Tuple{typeof(Base.convert), Type{Base.Option{Base.VersionNumber}}, Base.VersionNumber})
